export const projectsList = [
  ...
  },
  {
    ...
    description: `React.jsで実装した社員情報を登録、閲覧、検索、編集できる人事管理アプリです。
  ...
  },
  {
    ...
    description: `React.jsで実装したニュースフィードアプリです。フリーAPIからニュースデータを取得し、表示しています。
  ...
  },
  {
    ...
    description: `React.jsで実装した4択の国旗当てゲームです。フリーAPIから国旗関連の情報を取得しランダムに問題が出題されるよう構成しています。
